		...
		<table cellSpacing=0 cellPadding=0 width=776 align=center border=0>
			<tr>
				<td width="220" rowspan="3">
					<img src="images/jb_logo.jpg" width="200">
				</td>
			...
			<TBODY>
				<TR vAlign=top>
					...
					<TD>
						...
						<form method="POST" name="loginForm" onSubmit="return checkUserInfo()" action="loginServlet">
							<table width="100%" border="0">
								...
								<tr>
									...
									<td valign="top">
										<input type="text" name="id" size="19" class="input">
									</td>
									<td>
										&nbsp;
									</td>
								...
								<tr ><div style="margin-left:30%;"><%=(request.getAttribute("message")!=null)?"登撸失败":"" %></div></tr>
